...
### Train the GETNext
```
python train.py --data-train dataset/NYC_new/NYC_train.csv --data-val dataset/NYC_new/NYC_val.csv --data-adj-mtx dataset/NYC_new/graph_A.csv --data-node-feats dataset/NYC_new/graph_X.csv --time-units 48 --time-feature norm_in_day_time --poi-embed-dim 128 --user-embed-dim 128 --time-embed-dim 32 --cat-embed-dim 32 --node-attn-nhid 128 --transformer-nhid 1024 --transformer-nlayers 2 --transformer-nhead 2 --batch 20 --epochs 200 --use-embeddings True --name <exp_name>
```
