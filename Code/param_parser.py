...
def parameter_parser():
    ...
    parser.add_argument('--use-embeddings',
                        type=bool,
                        default=False,
                        help='Decide when to use custom embeddings')
    ...
    parser.add_argument('--state-dict',
                        type=str,
                        default='./runs/experiment/checkpoints/best_epoch.state.pt',
                        help='Saved models path')
